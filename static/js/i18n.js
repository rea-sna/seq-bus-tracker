...
const STRINGS = {
  en: {
    ...
    serverLoading: 'Starting up',
    serverLoadingMsg: 'Loading transit data. This may take a few minutes on first launch.',
    serverUpdating: 'Updating data',
    serverUpdatingMsg: 'Updating timetable data in the background. Please wait.',
    serverOffline: 'Cannot connect',
    serverOfflineMsg: 'Could not reach the server. Please check your connection.',
    serverRetry: 'Retry',
  ...
  ja: {
    ...
    serverLoading: '起動中',
    serverLoadingMsg: 'GTFSデータを準備しています。初回起動時は数分かかる場合があります。',
    serverUpdating: 'データ更新中',
    serverUpdatingMsg: '時刻表データをバックグラウンドで更新しています。しばらくお待ちください。',
    serverOffline: '接続できません',
    serverOfflineMsg: 'サーバーに接続できませんでした。接続を確認してください。',
    serverRetry: '再試行',
    serverChecking: '確認中…',
  }
};
